...
GO
ALTER TABLE [dbo].[FactStrategyPlan] ADD CONSTRAINT [PK_FactStrategyPlan_StrategyPlanKey] PRIMARY KEY CLUSTERED  ([StrategyPlanKey]) WITH (DATA_COMPRESSION = PAGE) ON [PRIMARY]
GO
